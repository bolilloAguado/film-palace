...
```
> [!IMPORTANT]
Antes de ejecutar el proyecto de manera local, es necesario ya sea, o crear un archivo `.env` en la carpeta raíz del proyecto, o modificar el archivo `.env.example`, con la `VITE_API_KEY` obtenida previamente en https://www.omdbapi.com/.
